...
export default StyleSheet.create({
    ...
    listMyCourseFooter: {
        marginBottom: globals.mph5 * 20,// 10
    },
    rmcdCardView: {
        marginHorizontal: globals.mpw5 * 3, //15,
        backgroundColor: "white",
        paddingTop: globals.mph5*2,//  5,
    ...
    likeImage: {
        width: globals.mpw5 * 6,// 30,
        height: globals.mph5 * 6,//  30,
        resizeMode: "contain"
    },
    likeText: {
